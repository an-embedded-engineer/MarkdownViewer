...
| `imageViewer.ts` | image viewerのfit / zoom / pan / wheel / intrinsic size policyと、Markdown DOM内の3種visualだけを扱うdecoration / resolverを提供する | [markdown-viewer-tauri/src/imageViewer.ts](../../../markdown-viewer-tauri/src/imageViewer.ts) |
